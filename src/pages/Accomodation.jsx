...
const Accommodation = () => {
    return (
        ...
        <p className="text-xl color-white pb-6 text-white md:p-4 sm:p-10">
        ...
        <p className="text-xl flex items-center pl-8 md:pt-6 sm: text-white">Kindly arrange for personal transport as there's no public transport available to and from the venue.
