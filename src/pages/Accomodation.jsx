const Accommodation = ({ id }) => {
  return (
    <div className='Acc h-auto pt-10 md:w-7/12 w-full mx-auto' id={id}>
      <h1 className='flex justify-center text-4xl md:text-7xl pt-8 title uppercase font-bold'>
        Accommodation
      </h1>
      <div className='grid md:grid-cols-2 grid-cols-1 gap-2 py-10 mb-8 space-y-6 md:space-y-0 pl-4 md:pl-0 font-title'>
        <div className='flex flex-col gap-y-4'>
          ...
          <button className='btn-primary text-white  items-center bg-black hover:text-[#FBF8F2] self-start hover:bg-black/80 duration-150'>
            <a
      ...
      <p className='text-xl font-title text-black pl-4 md:pl-0'>
