...
const Accommodation = () => {
    return (
        ...
        <p className="text-2xl color-white pb-6 text-white p-4">
        The wedding venue has accommodation that's dependent on availability. Kindly click here to have a view and book.
        </p>
        <button className="btn btn-primary  text-white rounded-md p-4 items-center ml-40 hover:bg-white hover:text-black">
        ...
        <p className="text-2xl color-white pb-6 text-white p-6">
        ...
        <p className="text-2xl flex items-center pl-8 pt-6 text-white">Kindly arrange for personal transport as there's no public transport available to and from the venue.
